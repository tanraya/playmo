...
// Load this file's selection again by visiting: http://mootools.net/more/edd6344da3b44f98080a5d7dadee55a6 
...
b.inherits.sets=d.inherits.sets||{};}return b;};}).call(this);Locale.define("en-GB","Date",{dateOrder:["date","month","year"],shortDate:"%d/%m/%Y",shortTime:"%H:%M"}).inherit("en-US","Date");
